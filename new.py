...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(average_sales, y='Automobile_Sales', x='Vehicle_Type', title='Average number of vehicles sold by vehicle type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_data, x='Vehicle_Type', y='Automobile_Sales',hover_data='Vehicle_Type',title='Average number of vehicles sold during the given year {}'.format(input_year)))
